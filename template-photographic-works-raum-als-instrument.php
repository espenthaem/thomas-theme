<?php
/*
Template Name: Photographic Works Raum Als Instrument
*/
?>
...
<div id="main-content">
	...
	<?php 
		...
		/* Force the raum-als-instrument category for radio works */
		$post = get_page_by_path('/arbeiten/' . 'raum-als-instrument');
